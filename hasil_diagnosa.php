...
<div style="width:500px; float:right;">
  ...
  <tr bgcolor="#FFFFFF">
	...
	$strP_Relasi=mysql_query("SELECT * FROM relasi WHERE kd_gejala IN (select kd_gejala FROM tmp_gejala) GROUP BY kd_penyakit");
	while ($dataP_Relasi=mysql_fetch_array($strP_Relasi)){
	...
	$str_Gejala_R=mysql_query("SELECT * FROM relasi,gejala WHERE relasi.kd_penyakit='$kd_penyakitR' AND relasi.kd_gejala=gejala.kd_gejala ORDER BY relasi.kd_gejala ASC ");
	$Egejala=1;
		while($dataGejala_R=mysql_fetch_array($str_Gejala_R)){
